<template>
  <div class="login">
    ...
    <!-- 操作状态弹窗 -->
    <resultsPopUp ref="resultsPopUpRef"></resultsPopUp>
  </div>
</template>
...
import resultsPopUp from "./module/resultsPopUp";
export default {
  name: "login",
  components: { Pop, Scan, Auth, Forget, Register, LoginAccount, resultsPopUp },
  data() {
    return {
      pop: false, //弹窗状态
  ...
  mounted(){
    // this.$refs.resultsPopUpRef.init('waitReview')
  },
  methods: {
    affirm(val) {
      this.type = val
